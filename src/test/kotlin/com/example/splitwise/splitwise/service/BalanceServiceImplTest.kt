...
//    @Test
//    fun getTotalBalance() {
//        `when`(userBillService.getUserBillsByUserId(userId = anyLong())).thenReturn(mutableListOf(userBill1, userBill2, userBill3))
...
//        `when`(userBillService.getUserBillsByUserId(userId = anyLong())).thenReturn(mutableListOf(userBill1, userBill2))
//        `when`(billService.getBill(billId = 1)).thenReturn(bill1)
//        `when`(billService.getBill(billId = 2)).thenReturn(bill2)
