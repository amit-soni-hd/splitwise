...
//        private var bill = Bill(billId = 1, ownerId = 1, billName = "party", description = "tour of goa", amount = 10000.0, date = LocalDateTime.now(),noOfUser = 2)
//
//    }
//
//
...
//        `when`(paymentRepository.findAllByPayerId(1)).thenReturn(listOf(payment))
//        val paymentsByPayerId = paymentService.getAllTransactionByUserId(1)
...
//        `when`(paymentRepository.findAllByBillId(1)).thenReturn(listOf(payment))
